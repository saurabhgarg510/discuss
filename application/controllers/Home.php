...
class Home extends CI_Controller {
    ...
    function sendResetPasswordEmail($email, $name) {
		...
		<body>
		<p>Dear ' . $name . ', <br><br>
		To reset your onlinehostelj.in password, <a href="' . base_url() . 'index.php/home/resetPassword/' . $email . '/' . $email_code . '">click here</a>. <br><br>
		If you are not able to view the link above, copy and paste into your address bar: 
		' . base_url() . 'index.php/home/resetPassword/' . $email . '/' . $email_code . '/ <br><br>
    ...
    public function resetPassword($email, $email_code) {
        ...
        if ($exists) {
            ...
            if ($email_code == $email_newcode) {
                ...
                $this->load->view('home/reset_error');
            }
        } else {
            $this->load->view('templates/header');
            $this->load->view('home/reset_error');
